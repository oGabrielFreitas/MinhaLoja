            ...
            <table class="tabelaPainelAdm" id="tabelaAdm">
                ...
                <tbody class="tbody-painel">
                    ...
                    <tr>
                        ...
                        <td id="campoDescricao">    <textarea readonly type="text" class="data<?=$counter?> textarea-adm" rows="3" cols="30"> <?=utf8_encode($datas['descricao'])?> </textarea></td>
                        ...
                        <td><input class="data<?=$counter?> botaoAlterar" type="button" value="Alterar" id="botaoAlterar" onclick="clicaAltera(<?=$counter?>)" >
                            ...
                            <input class="data<?=$counter?> botaoApagar" type="hidden" value="Apagar" id="botaoDeletar" >
